...
extension PickupPoint {
    static let samplePickupPointLists: [PickupPoint] =
        [
            PickupPoint(name: "Pickup point 1", coordinate: CLLocationCoordinate2D(latitude: 61.29, longitude: 24.96)),
            PickupPoint(name: "Pickup point 2", coordinate: CLLocationCoordinate2D(latitude: 62.29, longitude: 24.96)),
